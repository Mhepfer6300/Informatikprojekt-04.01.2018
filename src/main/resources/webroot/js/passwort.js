$(document).ready(function () {
   ...
   //     $("body").html("MK - Das Sportmagazin!")
   //              .append("Fußball Bundesliga Saison 2017/2018: /><br>\n")
   //              .append("<input type='button' value='Tabelle' id='TabellenButton'/>\n")
   //              .append("Wer ist der Toptorjäger und wer sind seine Verfolger?!:/><br>\n")
   //              .append("<input type='button' value='Top-Torschützen' id='Torschützenbutton'/>\n")
   //              .append("Die aller neusten Transfergerüchte im Überblick!:/><br>\n")
   //              .append("<input type='button' value='Tranfernews' id='Transferbutton'/>")
 ...
 // $(document).on("click", "#Torschützenbutton", function () {
   //     $("body").html("MK - Das Sportmagazin!<br><br>Die Top-Torjäger der Saison 2017/2018!")
   //              .append("1. Robert Lewandowski     (FC Bayern München)     15 Tore<br>2. Pierre-E. Aubameyang   (Borussia Dortmund)     13 Tore<br>3. Alfred Finnbogadon     (FC Augsburg)           11 Tore<br>4. Kevin Volland          (Bayer 04 Leverkusen)   10 Tore<br>5. Marc Uth               (TSG Hoffenheim)         9 Tore<br>6. Timo Werner            (RB Leipzig)             8 Tore<br>7. Nils Petersen          (SC Freiburg)            8 Tore<br>8. Michael Gregoritsch    (FC Augsburg)            8 Tore<br>9. Guidi Burgstaller      (FC Schalke)             7 Tore<br>10.Salomon Kalou          (Hertha BSC)             7 Tore<br><input type='text'/><br>\n")
   //              .append("<input type='button' value='Zurück zur Homepage' id='Homebutton'/>\n");
   // )};

    //$(document).on("click", "#Transferbutton", function () {
    //    $("body").html("MK - Das Sportmagazin!<br><br>Die heißesten Transfergerüchte und alle News zu den Vertragsverandlungen")
    //            .append("Zur Zeit ist der Transfermarkt leider geschlossen.<br>Schauen sie demnächst wieder vorbei um weitre Informationen zum Transfergeschen zu erhalten.")
    ...
    //            .append("1.FC Köln")
    //            .append("<input type='button' value='Köln' id='Kölnbutton'/>\n")
    //            .append("1.FSV Mainz 05")
    //            .append("<input type='button' value='Mainz' id='Mainzbutton'/>\n")
    //            .append("Bayer 04 Leverkusen")
    //            .append("<input type='button' value='Leverkusen' id='Leverkusenbutton'/>\n")
    //            .append("Borussia Dortmund")
    //            .append("<input type='button' value='Dortmund' id='Dortmundbutton'/>\n")
    //            .append("Borussia M'Gladbach")
    //            .append("<input type='button' value='Gladbach' id='Gladbachbutton'/>\n")
    //            .append("Eintracht Frankfurt")
    //            .append("<input type='button' value='Frankfurt' id='Frankfurtbutton'/>\n")
    //            .append("FC Augsburg")
    //            .append("<input type='button' value='Augsburg' id='Augsburgbutton'/>\n")
    //            .append("FC Bayern München")
    //            .append("<input type='button' value='München' id='Münchenbutton'/>\n")
    //            .append("FC Schalke 04")
    //            .append("<input type='button' value='Schalke' id='Schalkebutton'/>\n")
    //            .append("Hamburger SV")
    //            .append("<input type='button' value='Hamburg' id='Hamburgbutton'/>\n")
    //            .append("Hannover 96")
    //            .append("<input type='button' value='Hannover' id='Hannoverbutton'/>\n")
    //            .append("Hertha BSC")
    //            .append("<input type='button' value='Berlin' id='Berlinbutton'/>\n")
    //            .append("RB Leipzig")
    //            .append("<input type='button' value='Leipzig' id='Leipzigbutton'/>\n")
    //            .append("SC Freiburg")
    //            .append("<input type='button' value='Freiburg' id='Freiburgbutton'/>\n")
    //            .append("TSG Hoffenheim")
    //            .append("<input type='button' value='Hoffenheim' id='Hoffenheimbutton'/>\n")
    //            .append("VFB Stuttgart")
    //            .append("<input type='button' value='Stuttgart' id='Stuttgartbutton'/>\n")
    //            .append("VFL Wolfsburg")
    //            .append("<input type='button' value='Wolfsburg' id='Wolfsburgbutton'/>\n")
    //            .append("Werder Bremen")
    //            .append("<input type='button' value='Bremen' id='Bremenbutton'/>\n")
    //)};
